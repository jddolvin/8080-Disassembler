...
int Disassemble8080Op(unsigned char *codeBuffer, int pc)
{
    ...
    switch (*code)
    {
        ...
        case 0x72: printf("MOV  M,E"); break;
        ...
        case 0xca: printf("JZ   $%02x%02x", code[2], code[1]); opBytes=2; break;
        ...
        case 0xde: printf("SBI  #$%02x%02x", code[2], code[1]); opBytes=2; break;
